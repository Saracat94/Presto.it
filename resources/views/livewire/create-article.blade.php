<div>
    ...
    <div class="container">
        <div class="row my-3">
            <div class="col-12">
                <h2 class="f-sec fw-bold">Compila i dati</h2>

                {{-- form inserimento articoli --}}
                <form wire:submit.prevent="CreateArticle" class="f-main">
                    @csrf
                    <div class="my-3">
                    ...
                    <button type="submit" class="btn bot bg-acc">Inserisci il tuo articolo</button>
                </form>
